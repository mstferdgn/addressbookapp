        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlateCode = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_USERADRESS_CITY_CityId",
                        column: x => x.CityId,
                        principalTable: "CITY",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_USERADRESS_DISTRICT_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "DISTRICT",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_USERADRESS_NEIGBORHOOD_NeigborhoodId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_USERADRESS_CityId",
                table: "USERADRESS",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_USERADRESS_DistrictId",
                table: "USERADRESS",
                column: "DistrictId");

            migrationBuilder.CreateIndex(
                name: "IX_USERADRESS_NeigborhoodId",
                table: "USERADRESS",
